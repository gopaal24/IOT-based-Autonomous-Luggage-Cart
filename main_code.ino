...
// Serial components for bluetooth communication
...
// Geting and processing gps data 
...
// GPS Streaming on mobile through blynk
BLYNK_WRITE(V2) {
  GpsParam gps(param);
...
float geoHeading() {
  ...
  // Hold the module so that Z is pointing 'up' and you can measure the heading with x&y uisng the compass module
